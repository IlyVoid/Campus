...
// Function to draw horizontal lines on the map
void draw_horizontal(int ***iso_matrix, int **matrix, t_mlx *mlx_win, t_map_data data)
{
...
// Function to draw vertical lines on the map
void draw_vertical(int ***iso_matrix, int **matrix, t_mlx *mlx_win, t_map_data data)
{
    t_line_params line_param;
    int i = 0;
    int j;
...
// Function to draw the entire map by drawing both horizontal and vertical lines
